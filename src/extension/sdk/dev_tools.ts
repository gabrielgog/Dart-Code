...
export class DevToolsManager implements vs.Disposable {
	...
	public async spawnForSession(session: DartDebugSessionInformation, reuseWindows: boolean, notify: boolean, page: string | undefined): Promise<{ url: string, dispose: () => void } | undefined> {
